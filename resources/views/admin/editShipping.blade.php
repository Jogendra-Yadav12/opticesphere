                ...
                <div class="card card-white">
                    <div class="card-body row align-items-center">
                        <div class="col-12 col-sm">
                            <h4 class="mb-4 mb-sm-0 text-center text-sm-start">Edit Shipping Method</h4>
                        </div>
                        ...
                        <form action="{{ route('admin.shipping.update', $shipping->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <input type="text" name="code" class="form-control" value="{{ old('code', $shipping->code) }}" required>
                                </div>
                                <div class="col-md-4 form-group mb-3">
                                    <label>Base Cost (₹)</label>
                                    <input type="number" step="0.01" name="base_cost" class="form-control" value="{{ old('base_cost', $shipping->cost) }}" required>
                                </div>
                                
                                <div class="col-md-12 form-group mb-3">
                                    <label>Description</label>
                                    <textarea name="description" class="form-control" rows="3">{{ old('description', $shipping->description) }}</textarea>
                                </div>
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <div id="settings-container">
                                        @php
                                            $settings = is_string($shipping->settings) ? json_decode($shipping->settings, true) : $shipping->settings;
                                            $settings = is_array($settings) ? $settings : [];
                                        @endphp
                                        @forelse($settings as $key => $value)
                                            <div class="row mb-2 setting-row">
                                                <div class="col-md-5">
                                                    <input type="text" name="setting_keys[]" class="form-control" value="{{ $key }}" placeholder="Key (e.g. delivery_time)">
                                                </div>
                                                <div class="col-md-5">
