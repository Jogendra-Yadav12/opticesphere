...
<div class="page-inner">
    <div id="main-wrapper">
        ...
        <form class="needs-validation" action="{{ route($routePrefix . 'product.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            <!-- row -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="e.g. Ray-Ban Aviators" required>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <label for="imageUpload" class="custom-file-upload">
                                        ...
                                        <input type="file" id="imageUpload" name="image" class="d-none" accept="image/*" required onchange="previewImage(event)">
                                    </label>
                        ...
                        <div class="card-body">
                            ...
                            <div id="attributeGroups">
                                @forelse($attributes as $attribute)
                                    @include('admin.partials.attribute-selector', ['attribute' => $attribute, 'selectedValues' => []])
                                @empty
                        ...
                        <div class="card-body">
                            <div class="border-bottom pb-4 mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="special_price" id="special_price" placeholder="Optional">
                                </div>
                            </div>
                            <div class="mb-4">
                                <label for="stock" class="form-label fw-bold">Available Stock Quantity (Global)</label>
                                <input type="number" class="form-control" name="stock" id="stock" required>
                                <small class="text-muted d-block mt-2">Used if you do not add variants above.</small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-4">
                                    <button type="submit" class="btn btn-primary w-100 py-3 fw-bold">Publish Product</button>
                                </div>
                            </div>
                        </div>
                    </div>
