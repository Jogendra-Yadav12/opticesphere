            ...
            <div class="col-md-8 mx-auto grid-margin">
                <div class="card card-white">
                    <div class="card-heading clearfix">
                        <h4 class="card-title">Add Category or Subcategory</h4>
                        <p class="text-muted small mb-0">Fill out this form to add a new Category. To add a Subcategory instead, simply select a Parent Category from the dropdown.</p>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.category.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <label for="imageUpload" class="custom-file-upload p-4 text-center d-block rounded" style="border: 2px dashed #d1d5db; cursor: pointer; transition: border-color .15s ease;">
                                    ...
                                    <h6 class="mb-0">Click to upload image</h6>
                                ...
                                <div class="text-center mt-3">
                                    <img id="imagePreview" src="#" alt="Preview" style="display: none; max-height: 200px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary w-100 py-3 fw-bold">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
